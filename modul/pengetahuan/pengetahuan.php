		...
		default:
          ...
          <br><br>
		  	<table class='table table-bordered'>
		  		<tr>
		  			<td>
		  				<input class='btn bg-green margin' type=button name=tambah value='Tambah Basis Pengetahuan' onclick=\"window.location.href='pengetahuan/tambahpengetahuan';\">
		  			</td>
		  			<td>
		  			...
		  			<td>
						<input class='btn bg-green margin' type=submit value='   Cari   ' name=Go>
		  			</td> 
		  		</tr>
          	</table>
		  </form>";
	...
	<form name=text_form method=POST action='$aksi?module=pengetahuan&act=update' onsubmit='return Blank_TextField_Validator()'>
		  ...
		  <tr><td width=120>Penyakit</td><td><select class='form-control' name='kode_penyakit' id='kode_penyakit'>";
			...
			while ($r4 = mysqli_fetch_array($hasil4)) {
				...
				if ($r['kode_penyakit'] == $r4['kode_penyakit'])
					echo "selected";
		...
		<tr><td>Gejala</td><td><select class='form-control' name='kode_gejala' id='kode_gejala'>";
			...
			while ($r4 = mysqli_fetch_array($hasil4)) {
				...
				if ($r['kode_gejala'] == $r4['kode_gejala'])
					echo "selected";
